...
class RouteMapViewController: UIViewController {
    ...
    var route: Route { return navigationService.router.route }
    ...
    func resumeNotifications() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(updateInstructionsBanner(notification:)), name: .routeControllerDidPassVisualInstructionPoint, object: nil)
    ...
    func showEndOfRoute(duration: TimeInterval = 1.0, completion: ((Bool) -> Void)? = nil) {
        ...
        if let coordinates = route.coordinates, let userLocation = navigationService.router.location?.coordinate {
