...
open class DayStyle: Style {
    ...
    open override func apply() {
        ...
        BottomBannerStackView.appearance().backgroundColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)
...
open class NightStyle: DayStyle {
    ...
    open override func apply() {
        ...
        BottomBannerStackView.appearance().backgroundColor = backgroundColor
