    ...
    */
    ...
    func shape(describing route: Route, legIndex: Int?) -> MGLShape? {
        ...
        for (index, leg) in route.legs.enumerated() {
            ...
            // We don't need both.
            var legCoordinates = Array(leg.steps.compatibleFlatMap {
    ...
    func shape(describingCasing route: Route, legIndex: Int?) -> MGLShape? {
        ...
        for (index, leg) in route.legs.enumerated() {
            let legCoordinates = Array(leg.steps.compatibleFlatMap {
                $0.coordinates
            }.joined())
    ...
    @objc public func localizeLabels() {
        ...
        let streetsSourceIdentifiers = style.sources.compatibleFlatMap {
