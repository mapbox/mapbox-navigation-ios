...
public class LanesStyleKit : NSObject {
    ...
    @objc dynamic public class func drawLane_slight_right(primaryColor: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000), scale: CGFloat = 1) {
        ...
        bezier3Path.addCurve(to: CGPoint(x: -12.38, y: 9.37), controlPoint1: CGPoint(x: -11.9, y: 6.11), controlPoint2: CGPoint(x: -12.38, y: 7.72))
        bezier3Path.addLine(to: CGPoint(x: -12.38, y: 14.76))
        primaryColor.setStroke()
        bezier3Path.lineWidth = 4
        ...
        bezier4Path.move(to: CGPoint(x: -8.39, y: -5.75))
        bezier4Path.addLine(to: CGPoint(x: 1.32, y: -6.29))
        bezier4Path.addLine(to: CGPoint(x: -0.62, y: 3.25))
        bezier4Path.addCurve(to: CGPoint(x: -0.75, y: 3.5), controlPoint1: CGPoint(x: -0.63, y: 3.35), controlPoint2: CGPoint(x: -0.67, y: 3.44))
        bezier4Path.addCurve(to: CGPoint(x: -1.28, y: 3.46), controlPoint1: CGPoint(x: -0.91, y: 3.64), controlPoint2: CGPoint(x: -1.14, y: 3.62))
        bezier4Path.addCurve(to: CGPoint(x: -1.33, y: 3.39), controlPoint1: CGPoint(x: -1.3, y: 3.44), controlPoint2: CGPoint(x: -1.33, y: 3.39))
        bezier4Path.addLine(to: CGPoint(x: -3.12, y: 0.2))
        bezier4Path.addCurve(to: CGPoint(x: -3.18, y: 0.1), controlPoint1: CGPoint(x: -3.13, y: 0.16), controlPoint2: CGPoint(x: -3.15, y: 0.13))
        bezier4Path.addCurve(to: CGPoint(x: -3.84, y: 0.18), controlPoint1: CGPoint(x: -3.31, y: -0.05), controlPoint2: CGPoint(x: -3.69, y: 0.05))
        bezier4Path.addCurve(to: CGPoint(x: -5.41, y: 1.55), controlPoint1: CGPoint(x: -4.05, y: 0.36), controlPoint2: CGPoint(x: -5.41, y: 1.55))
        bezier4Path.addLine(to: CGPoint(x: -6.4, y: 0.4))
        bezier4Path.addLine(to: CGPoint(x: -7.39, y: -0.75))
        bezier4Path.addCurve(to: CGPoint(x: -5.82, y: -2.11), controlPoint1: CGPoint(x: -7.39, y: -0.75), controlPoint2: CGPoint(x: -6.02, y: -1.93))
        bezier4Path.addCurve(to: CGPoint(x: -5.72, y: -2.7), controlPoint1: CGPoint(x: -5.67, y: -2.24), controlPoint2: CGPoint(x: -5.58, y: -2.54))
        bezier4Path.addCurve(to: CGPoint(x: -5.76, y: -2.8), controlPoint1: CGPoint(x: -5.74, y: -2.73), controlPoint2: CGPoint(x: -5.73, y: -2.78))
        bezier4Path.addLine(to: CGPoint(x: -8.64, y: -5.05))
        bezier4Path.addCurve(to: CGPoint(x: -8.69, y: -5.12), controlPoint1: CGPoint(x: -8.64, y: -5.05), controlPoint2: CGPoint(x: -8.68, y: -5.1))
        bezier4Path.addCurve(to: CGPoint(x: -8.65, y: -5.65), controlPoint1: CGPoint(x: -8.83, y: -5.28), controlPoint2: CGPoint(x: -8.81, y: -5.52))
        bezier4Path.addCurve(to: CGPoint(x: -8.39, y: -5.75), controlPoint1: CGPoint(x: -8.58, y: -5.72), controlPoint2: CGPoint(x: -8.48, y: -5.75))
        bezier4Path.close()
        primaryColor.setFill()
        bezier4Path.fill()
