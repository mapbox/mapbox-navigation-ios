...
extension BottomBannerViewController {
    ...
    fileprivate func setupVerticalCompactLayout(_ c: inout [NSLayoutConstraint]) {
        c.append(view.heightAnchor.constraint(equalToConstant: 50))
        
        c.append(cancelButton.widthAnchor.constraint(equalTo: view.heightAnchor))
        c.append(cancelButton.topAnchor.constraint(equalTo: view.topAnchor))
        c.append(cancelButton.trailingAnchor.constraint(equalTo: view.trailingAnchor))
        c.append(cancelButton.bottomAnchor.constraint(equalTo: view.bottomAnchor))
        
        c.append(timeRemainingLabel.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 10))
        ...
        c.append(verticalDividerView.centerYAnchor.constraint(equalTo: view.centerYAnchor))
        ...
        c.append(horizontalDividerView.topAnchor.constraint(equalTo: view.topAnchor))
        c.append(horizontalDividerView.leadingAnchor.constraint(equalTo:view.leadingAnchor))
        c.append(horizontalDividerView.trailingAnchor.constraint(equalTo: view.trailingAnchor))
    ...
    fileprivate func setupVerticalRegularLayout(_ c: inout [NSLayoutConstraint]) {
        c.append(view.heightAnchor.constraint(equalToConstant: 80))
        
        c.append(timeRemainingLabel.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 10))
        c.append(timeRemainingLabel.lastBaselineAnchor.constraint(equalTo: view.centerYAnchor, constant: 0))
        ...
        c.append(arrivalTimeLabel.centerYAnchor.constraint(equalTo: view.centerYAnchor))
        c.append(arrivalTimeLabel.trailingAnchor.constraint(equalTo: verticalDividerView.leadingAnchor, constant: -10))
    }
