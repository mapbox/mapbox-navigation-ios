...
open class NextBannerView: UIView {
    ...
    override open func prepareForInterfaceBuilder() {
        ...
        instructionLabel.instruction = [VisualInstructionComponent(type: .text, text: "Next step", imageURL: nil, abbreviation: nil, abbreviationPriority: NSNotFound)]
    }
    ...
    public func update(for routeProgress: RouteProgress) {
        ...
        instructionLabel.instruction = instruction.primaryInstruction.textComponents
        show()
    }
