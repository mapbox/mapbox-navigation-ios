...
class NavigationViewControllerTests: XCTestCase {
    ...
    override func setUp() {
        ...
        newRouteResponse = Fixture.routeResponse(from: jsonFileName, options: routeOptions)
        dependencies = {
    ...
    func testDestinationAnnotationUpdatesUponReroute() {
        ...
        navigationViewController.indexedRouteResponse = (initialRouteResponse, 0)
        ...
        navigationViewController.indexedRouteResponse = (newRouteResponse, 0)
