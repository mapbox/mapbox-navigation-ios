...
1. Set Rules to Version, Up to Next Major, and enter `2.1.0` as the minimum version requirement. Click Next.
...
.package(name: "MapboxCoreNavigation", url: "https://github.com/mapbox/mapbox-navigation-ios.git", from: "2.1.0")
// Latest prerelease
.package(name: "MapboxCoreNavigation", url: "https://github.com/mapbox/mapbox-navigation-ios.git", .exact("2.1.0-rc.2"))
```
...
1. Create a [Cartfile](https://github.com/Carthage/Carthage/blob/master/Documentation/Artifacts.md#github-repositories) with the following dependency:
   ```cartfile
   # Latest stable release
   github "mapbox/mapbox-navigation-ios" ~> 2.1
   # Latest prerelease
   github "mapbox/mapbox-navigation-ios" "v2.1.0-rc.2"
   ```
