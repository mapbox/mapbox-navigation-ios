...
struct OfflineServiceConstants {
    ...
    static let pauseDownloadingMapsPack = NSLocalizedString("PAUSE_MAPS_TITLE", value: "Pause downloading Maps Pack", comment: "Pause downloading Maps Pack.")
    static let continueDownloadingMapsPack = NSLocalizedString("CONTINUE_MAPS_TITLE", value: "Continue downloading Maps Pack", comment: "Continue downloading Maps Pack.")
    ...
    static let pauseDownloadingNavigationPack = NSLocalizedString("PAUSE_NAVIGATION_PACK_TITLE", value: "Pause downloading Navigation Pack", comment: "Pause downloading Navigation Pack.")
    static let continueDownloadingNavigationPack = NSLocalizedString("CONTINUE_NAVIGATION_PACK_TITLE", value: "Continue downloading Navigation Pack", comment: "Continue downloading Navigation Pack.")
