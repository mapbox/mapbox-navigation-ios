...
extension SceneDelegate: NavigationMapViewDelegate {
    ...
    func navigationMapView(_ navigationMapView: NavigationMapView, didSelect alternativeRoute: AlternativeRoute) {
        guard let routePreviewViewController = previewViewController.topBanner(at: .bottomLeading) as? RoutePreviewViewController else {
            return
        }
        ...
        previewViewController.navigationView.bottomBannerContainerView.hide(animated: shouldAnimate,
            ...
            let navigationViewController = NavigationViewController(
                ...
                navigationOptions: NavigationOptions(
                    mapboxNavigation: self.navigationProvider,
