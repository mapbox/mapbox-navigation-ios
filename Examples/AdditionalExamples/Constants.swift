...
struct NamedController {
    ...
    /// Is the example contained in a storyboard? If so, we assume the Initial View Controller of the storyboard.
    let pushExampleToViewController: Bool
    /// If the example does not go directly into the example (i.e., another map is shown), set this value to true
    let exactController: UIViewController?
    ...
    init(
        ...
        pushExampleToViewController: Bool = false,
        exactController: UIViewController? = nil
    ) {
        self.name = name
        self.description = description
        self.controller = controller
        self.storyboard = storyboard
        self.pushExampleToViewController = pushExampleToViewController
        self.exactController = exactController
    }
}
...
let listOfExamples: [NamedController] = [
    .init(
        name: "SwiftUI",
        description: "SwiftUI usage examples",
        controller: nil,
        storyboard: nil,
        pushExampleToViewController: true,
        exactController: createSwiftUIExamplesController()
    ),
    .init(
