...
NSString *const MBRouteControllerDidFindFasterAlternateRouteKey  = @"fasterRoute";
...
NSString *const MBRouteControllerDidFindFasterAlternateRoute    = @"RouteControllerDidFindFasterAlternateRoute";
