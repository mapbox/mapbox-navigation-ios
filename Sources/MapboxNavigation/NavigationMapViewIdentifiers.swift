...
extension NavigationMapView {
    ...
    struct LayerIdentifier {
        ...
        static let TLLabelLayer = "\(identifier)_TLLabelLayer"
        static let voiceInstructionCircleLayer = "\(identifier)_voiceInstructionCircleLayer"
        static let TLCircleLayer = "\(identifier)_TLCircleLayer"
    ...
    struct SourceIdentifier {
        ...
        static let TLLabelSource = "\(identifier)_tl_label_Source"
