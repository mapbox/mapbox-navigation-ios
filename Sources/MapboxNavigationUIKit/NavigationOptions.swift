...
/**
 ...
 - note: `NavigationOptions` is designed to be used with the `NavigationViewController` class to customize the user experience. To specify criteria when calculating routes, use the `NavigationRouteOptions` class. To modify user preferences that persist across navigation sessions, use the `CoreConfig` class.
 */
open class NavigationOptions {
    ...
    /**
     ...
     This option controls how the map view will try to proactively fetch data related to the route. A `nil` value disables the feature.
     */
    ...
    /**
     ...
     - parameter mapboxNavigation: The navigation service that manages navigation along the route.
     ...
     - parameter eventsManager: The events manager, used to send user feedback.
     ...
     - parameter predictiveCacheManager: Configuration for predictive caching.
