...
public enum WaypointStyle: Int {
    ...
    /// Highlight destination building on arrival in 2D. In case if destination building wasn't found only annotation
    /// will be shown.
    case building

    /// Highlight destination building on arrival in 3D. In case if destination building wasn't found only annotation
    /// will be shown.
