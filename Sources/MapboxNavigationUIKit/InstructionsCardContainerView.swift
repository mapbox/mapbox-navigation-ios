...
public class InstructionsCardContainerView: StylableView, InstructionsCardContainerViewDelegate {
    ...
    private func setupInformationStackView() {
        ...
        let informationStackViewLeadingConstraint = informationStackView.leadingAnchor
            .constraint(equalTo: leadingAnchor)
        let informationStackViewTrailingConstraint = informationStackView.trailingAnchor
    ...
    public func label(
        ...
        if let primaryLabel = label as? PrimaryLabel,
           let presented = delegate?.primaryLabel(
               primaryLabel,
           ...
           )
        {
            return presented
                  ...
                  let presented = delegate?.secondaryLabel(
                      secondaryLabel,
                      willPresent: instruction,
                      as: presented
                  )
        {
            ...
            let textColor = highlighted ? instructionsCardView.primaryLabel.textColor : instructionsCardView
                .primaryLabel.textColorHighlighted
            let attributes = [
