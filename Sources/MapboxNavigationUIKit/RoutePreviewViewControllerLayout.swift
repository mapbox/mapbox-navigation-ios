    ...
    func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            startButton.trailingAnchor.constraint(
                equalTo: bottomBannerView.trailingAnchor,
                constant: -10.0
            ),
        ...
        NSLayoutConstraint.activate([
            timeRemainingLabel.leadingAnchor.constraint(
                equalTo: bottomBannerView.leadingAnchor,
                constant: 10.0
            ),
            timeRemainingLabel.lastBaselineAnchor.constraint(
            ...
            timeRemainingLabel.trailingAnchor.constraint(
                equalTo: bottomBannerView.trailingAnchor,
                constant: -10.0
            ),
        ])

        let distanceRemainingLabelWidthConstraint = distanceRemainingLabel.widthAnchor
            .constraint(lessThanOrEqualToConstant: 10.0)
        ...
        NSLayoutConstraint.activate([
            ...
            distanceRemainingLabel.leadingAnchor.constraint(
                equalTo: bottomBannerView.leadingAnchor,
                constant: 10.0
            ),
            distanceRemainingLabel.topAnchor.constraint(
        ...
        NSLayoutConstraint.activate([
            ...
            arrivalTimeLabel.trailingAnchor.constraint(
                equalTo: startButton.leadingAnchor,
                constant: -10.0
            ),
            arrivalTimeLabel.leadingAnchor.constraint(
                equalTo: distanceRemainingLabel.trailingAnchor,
                constant: 10.0
            ),
            arrivalTimeLabel.topAnchor.constraint(
                equalTo: timeRemainingLabel.bottomAnchor,
                constant: 0.0
            ),
        ])
