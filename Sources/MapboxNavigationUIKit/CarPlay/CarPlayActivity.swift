/// The activity during which a `CPTemplate` is displayed. This enumeration is used to distinguish between different
/// templates during different phases of user interaction.
public enum CarPlayActivity: Int, Sendable {
