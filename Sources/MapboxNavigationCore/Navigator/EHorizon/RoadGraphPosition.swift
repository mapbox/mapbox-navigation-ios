...
extension RoadGraph {
    ...
    public struct Position: Equatable, Sendable {
        ...
        /// Initializes a new ``RoadGraph/Position`` object with a given edge identifier and fraction from the start of
        /// the edge.
        /// - Parameters:
        ///   - edgeIdentifier: The edge identifier.
        ///   - fractionFromStart: The fraction from the start of the edge.
...
extension GraphPosition {
    convenience init(_ position: RoadGraph.Position) {
        self.init(
            edgeId: UInt64(position.edgeIdentifier),
