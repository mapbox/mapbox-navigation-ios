...
extension UIColor {
    ...
    public class var defaultRouteAnnotationCaptionTextColor: UIColor { #colorLiteral(red: 0.01960784314, green: 0.02745098039, blue: 0.03921568627, alpha: 1) }
    public class var defaultSelectedRouteAnnotationTextColor: UIColor { #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1) }
    public class var defaultSelectedRouteAnnotationCaptionTextColor: UIColor { #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1) }
