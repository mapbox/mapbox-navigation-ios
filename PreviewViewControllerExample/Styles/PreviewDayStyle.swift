...
class PreviewDayStyle: DayStyle {
    ...
    override func apply() {
        ...
        tintColor = PreviewDayStyle.defaultTintColor
        ...
        CameraModeFloatingButton.appearance(for: phoneTraitCollection).backgroundColor = #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0)
        CameraModeFloatingButton.appearance(for: phoneTraitCollection).borderColor = #colorLiteral(red: 0.804, green: 0.816, blue: 0.816, alpha: 1)
        CameraModeFloatingButton.appearance(for: phoneTraitCollection).borderWidth = 2.0
        CameraModeFloatingButton.appearance(for: phoneTraitCollection).cornerRadius = 10.0
        CameraModeFloatingButton.appearance(for: phoneTraitCollection).tintColor = #colorLiteral(red: 0.237, green: 0.242, blue: 0.242, alpha: 1)
        ...
        BackButton.appearance(for: phoneTraitCollection).backgroundColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)
        BackButton.appearance(for: phoneTraitCollection).borderColor = #colorLiteral(red: 0.804, green: 0.816, blue: 0.816, alpha: 1)
        BackButton.appearance(for: phoneTraitCollection).borderWidth = 2.0
        BackButton.appearance(for: phoneTraitCollection).cornerRadius = 10.0
        BackButton.appearance(for: phoneTraitCollection).textColor = #colorLiteral(red: 0.237, green: 0.242, blue: 0.242, alpha: 1)
        BackButton.appearance(for: phoneTraitCollection).textFont = UIFont.systemFont(ofSize: 15, weight: .regular)
        BackButton.appearance(for: phoneTraitCollection).tintColor = #colorLiteral(red: 0.237, green: 0.242, blue: 0.242, alpha: 1)
