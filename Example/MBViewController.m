...
@interface MBViewController () <AVSpeechSynthesizerDelegate>
...
- (void)startNavigation:(MBRoute *)route {
    ...
    MBNavigationViewController *controller = [[MBNavigationViewController alloc] initWithRoute:route styles:nil navigationService:service voiceController: nil bottomBanner:nil];
