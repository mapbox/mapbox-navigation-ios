...
xcodebuild -sdk iphonesimulator -destination 'platform=iOS Simulator,OS=12.1,name=iPhone X' -project MapboxNavigation.xcodeproj -scheme MapboxNavigation clean build test | xcpretty
