...
* Feedback catgories and subcategories for active navigation were changed. For the updated list of supported categories see file `ActiveNavigationFeedbackType.swift`. ([#3339]((https://github.com/mapbox/mapbox-navigation-ios/pull/3339))
