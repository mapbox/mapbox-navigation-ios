...
* Fixed an issue when continuous alternative route lines and their corresponding callouts where misplaced on long routes. ([#4176](https://github.com/mapbox/mapbox-navigation-ios/pull/4176))
