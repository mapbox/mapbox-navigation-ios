...
* Fixed an issue where the current road name label sometimes displayed the name of an intersecting road instead of the current road or blinked in and out with `NavigationStatus.roadName`. ([#3257](https://github.com/mapbox/mapbox-navigation-ios/pull/3257))
