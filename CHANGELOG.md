...
* MapboxCoreNavigation now requires [MapboxDirections v2.10.0](https://github.com/mapbox/mapbox-directions-swift/releases/tag/v2.10.0). ([#4390](https://github.com/mapbox/mapbox-navigation-ios/pull/4390))
