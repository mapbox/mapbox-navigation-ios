...
* Added the `NavigationLocationProvider` class to conform to `LocationProvider` protocol, which depends on `NavigationLocationManager` to detect the user’s location as it changes during turn-by-turn navigation. ([#3070](https://github.com/mapbox/mapbox-navigation-ios/pull/3070))
* Renamed `PassiveLocationManager` to `PassiveLocationProvider`. ([#3070](https://github.com/mapbox/mapbox-navigation-ios/pull/3070))
