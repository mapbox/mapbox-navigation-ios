...
* MapboxCoreNavigation now depends on [MapboxDirections v2.0.0](https://github.com/mapbox/mapbox-directions-swift/releases/tag/v2.0.0). ([#3413](https://github.com/mapbox/mapbox-navigation-ios/pull/3413))
