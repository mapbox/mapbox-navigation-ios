...
* Added `ReplayLocationManager(historyFileDump:)` and `MapboxNavigationService(historyFileDump:customRoutingProvider:credentials:eventsManagerType:routerType:customActivityType:)` for replaying trips recorded by a history file. ([#4194](https://github.com/mapbox/mapbox-navigation-ios/pull/4194))
...
* Added `HistoryFileReader` for parsing history files. ([#4194](https://github.com/mapbox/mapbox-navigation-ios/pull/4194))
