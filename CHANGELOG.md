...
* Fixed an issue when `SimulatedLocationManager` could freeze the main thread when working with long routes. ([#3672](https://github.com/mapbox/mapbox-navigation-ios/pull/3672))
