...
* Exposed `MapboxVoiceController.speak(_:data:)` method and `MapboxVoiceController.removeSpeechSynthesizer` property for convenient subclassing and customization.
