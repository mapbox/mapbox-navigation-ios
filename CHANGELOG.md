...
* Fixed an issue where a black background could be rendered in a ManeuverView arrow regardless of the backgroundColor set on the view. ([#2278](https://github.com/mapbox/mapbox-navigation-ios/pull/2278))
