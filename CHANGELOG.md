...
* Fixed an issue where `UserPuckCourseView` is trimmed when using custom frame for `NavigationMapView.userLocationStyle`. ([#3601](https://github.com/mapbox/mapbox-navigation-ios/pull/3601))
