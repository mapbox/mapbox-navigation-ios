...
* MapboxCoreNavigation now requires [MapboxDirections v2.4.0](https://github.com/mapbox/mapbox-directions-swift/releases/tag/v2.4.0). ([#3817](https://github.com/mapbox/mapbox-navigation-ios/pull/3829))
