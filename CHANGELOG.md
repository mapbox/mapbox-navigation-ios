...
* MapboxNavigation now requires [MapboxMaps v10.5.0](https://github.com/mapbox/mapbox-maps-ios/releases/tag/v10.5.0). ([#](https://github.com/mapbox/mapbox-navigation-ios/pull/))
...
* MapboxCoreNavigation now requires [MapboxNavigationNative v99._x_](https://github.com/mapbox/mapbox-navigation-native-ios/releases/tag/99.0.0). ([#](https://github.com/mapbox/mapbox-navigation-ios/pull/))
