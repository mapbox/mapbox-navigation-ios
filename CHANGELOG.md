...
* MapboxCoreNavigation now requires [MapboxDirections v2.8.0](https://github.com/mapbox/mapbox-directions-swift/releases/tag/v2.8.0). ([#4251](https://github.com/mapbox/mapbox-navigation-ios/pull/4251))
