...
* MapboxNavigation now depends on [MapboxMaps v10.0.0-rc.4](https://github.com/mapbox/mapbox-maps-ios/). ([#3162](https://github.com/mapbox/mapbox-navigation-ios/pull/3162))
