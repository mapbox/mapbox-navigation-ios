...
* MapboxNavigation now depends on [MapboxMaps v10.0.0-rc.7](https://github.com/mapbox/mapbox-maps-ios/). ([#3299](https://github.com/mapbox/mapbox-navigation-ios/pull/3299))
* MapboxNavigation now depends on MapboxNavigationNative v64.0.0. ([#3299](https://github.com/mapbox/mapbox-navigation-ios/pull/3299))
* MapboxNavigation now depends on MapboxCommon v17.1.0. ([#3299](https://github.com/mapbox/mapbox-navigation-ios/pull/3299))
