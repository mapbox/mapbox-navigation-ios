...
* Deprecate `PassiveLocationManager.startUpdatingLocation` in favour of `PassiveLocationManager.startTripSession()` which works better with new pricing option. ([#3362](https://github.com/mapbox/mapbox-navigation-ios/pull/3362)).
