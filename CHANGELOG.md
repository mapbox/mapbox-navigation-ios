...
* MapboxCoreNavigation now requires [MapboxDirections v2.7.0-rc.2](https://github.com/mapbox/mapbox-directions-swift/releases/tag/v2.7.0-rc.2). ([#4144](https://github.com/mapbox/mapbox-navigation-ios/pull/4144))
