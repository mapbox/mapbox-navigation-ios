...
* Fixed these incorrectly declared `NavigationMapViewDelegate` class' Objective-C method signatures:  `NavigationMapViewDelegate.navigationMapView(_:shapeDescribing:)`, `NavigationMapViewDelegate.navigationMapView(_:shapeDescribingWaypoints:)`, `NavigationMapViewDelegate.navigationMapView(_:shapeFor:)`, `NavigationMapViewDelegate.navigationMapView(_:imageFor:)`, `NavigationMapViewDelegate.navigationMapView(_:viewFor:)`.
