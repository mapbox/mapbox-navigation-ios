...
* MapboxCoreNavigation now requires [MapboxDirections v2.6.0-rc.1](https://github.com/mapbox/mapbox-directions-swift/releases/tag/v2.6.0-rc.1). ([#](https://github.com/mapbox/mapbox-navigation-ios/pull/))
