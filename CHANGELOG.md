...
* MapboxCoreNavigation now requires [MapboxNavigationNative v132.2.0](https://github.com/mapbox/mapbox-navigation-native-ios/releases/tag/132.2.0). ([#4454](https://github.com/mapbox/mapbox-navigation-ios/pull/4454))
* MapboxNavigation now requires [MapboxMaps v10.13.1](https://github.com/mapbox/mapbox-maps-ios/releases/tag/v10.13.1). ([#4454](https://github.com/mapbox/mapbox-navigation-ios/pull/4454))
* MapboxCoreNavigation now requires [MapboxDirections v2.10.0](https://github.com/mapbox/mapbox-directions-swift/releases/tag/v2.10.0). ([#4454](https://github.com/mapbox/mapbox-navigation-ios/pull/4454))
