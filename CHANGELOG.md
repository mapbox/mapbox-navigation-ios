...
* MapboxCoreNavigation now requires [MapboxDirections v2.9.0](https://github.com/mapbox/mapbox-directions-swift/releases/tag/v2.9.0). ([#4336](https://github.com/mapbox/mapbox-navigation-ios/pull/4336))
