...
* Added `Notification.Name.electronicHorizonDidPassRoadObject` and `Navigator.onRoadObjectPassed(for:)` to detect when the user has passed a point-like object. ([#2991](https://github.com/mapbox/mapbox-navigation-ios/pull/2991))
* `Navigator.onPositionUpdated(for:distances:)` now requires that `distances:` input be of type `[MapboxNavigationNative.RoadObjectDistance]`. ([#2991](https://github.com/mapbox/mapbox-navigation-ios/pull/2991))
...
* Added `RoadObjectsStore.roadObject(identifier:)`. ([#2991](https://github.com/mapbox/mapbox-navigation-ios/pull/2991))
* Replaced `RoadObjectType.tunnelEntrance` and `RoadObjectType.tunnelExit` in favor of `RoadObjectType.tunnel`. ([#2991](https://github.com/mapbox/mapbox-navigation-ios/pull/2991))
