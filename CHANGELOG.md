...
* Added `RouterDelegate.router(:shouldProactivelyRerouteFrom:to:completion)` method to inform and providing control over each individual proactive rerouting attempt. ([#4229](https://github.com/mapbox/mapbox-navigation-ios/pull/4229))
