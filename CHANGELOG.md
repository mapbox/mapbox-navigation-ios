...
* Added `RoadObjectDistanceInfo` enum which contains information about distance to the road object of a concrete type/shape (gantry, polygon, line, point, subgraph). ([#2991](https://github.com/mapbox/mapbox-navigation-ios/pull/2991))
