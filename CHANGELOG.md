...
* `MapboxNavigationNative` version bumped to v26.3, `MapboxCommon` updated to v9.1.0 and `MapboxDirections.swift` to v1.1  ([#2694](https://github.com/mapbox/mapbox-navigation-ios/pull/2694)
