# -*- encoding: utf-8 -*-
# stub: google-apis-androidpublisher_v3 0.22.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<google-apis-core>.freeze, [">= 0.5", "< 2.a"])
  else
    s.add_dependency(%q<google-apis-core>.freeze, [">= 0.5", "< 2.a"])
  end
end
